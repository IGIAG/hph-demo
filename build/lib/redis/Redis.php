...
class Redis {
	...
	public function keys ($pattern) {
		#/home/igiag/haxe-files/hxneko-redis/3,0,1/redis/Redis.hx:104: characters 3-51
		$this->protocol->sendMultiBulkCommand("KEYS", \Array_hx::wrap([$pattern]));
		#/home/igiag/haxe-files/hxneko-redis/3,0,1/redis/Redis.hx:105: characters 3-37
		return $this->protocol->receiveMultiBulk();
	}
